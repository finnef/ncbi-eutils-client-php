...
class NCBIEFetchByIDTest extends UnitTestCase
{
    ...
    public function test_fetch_by_id()
    {
        ...
        foreach ($file_names as $file_name) {
            ...
            // Re-enable this after adding support for a records_per_download property:
            //$this->assertTrue( $file_count == $this->records_per_download );
            $download_count += $file_count;
        }
        $this->assertTrue( $download_count == count($ids) );
